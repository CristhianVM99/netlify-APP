            ...
            <div class="blog-deatails">
              ...
              <div class="blog-full">
                <div class="blog-desc">
                  ...
                  <p class="content_home" v-html="Institucion.institucion_sobre_ins"></p>
                </div>
                <blockquote>
                  <p>
...
export default {
  ...
  data() {
    return {
      ...
      opacidadbg: 1,
      coloricon: '#fff',
      iframeHtml: '<iframe frameborder="0" src="//www.youtube.com/embed/RcsOSIghvRk" width="640" height="360" class="note-video-clip"></iframe>',
    }
  },
  computed: {
    ...mapState([
  ...
  methods: {    
    changeVideo() {
      const newIframeHtml = '<iframe width="100%" height="480" src="https://www.youtube.com/embed/mnER0a9GbSQ" title="UPEA UNIVERSIDAD PÚBLICA EL ALTO" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen class="note-video-clip"></iframe>';            
      const iframeElement = document.querySelector('.note-video-clip');

      if (iframeElement) {
        iframeElement.style.width = "100%";
        iframeElement.outerHTML = newIframeHtml;
      }
    },
